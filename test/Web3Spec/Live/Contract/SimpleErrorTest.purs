...
type NamesFn = Tagged (SProxy "names(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))
...
type TableFn = Tagged (SProxy "table(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))
...
type TestBoolFn = Tagged (SProxy "testBool(bool)") (Tuple1 (Tagged (SProxy "_arg") Boolean))
