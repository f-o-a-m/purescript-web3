...
utilsSpec = describe "utils-spec" do
    ...
    describe "utf tests" do
      ...
      it "can convert hex strings to utf8" do
        toUtf8 (unsafeHexString "6d79537472696e67") `shouldEqual` "myString"
        toUtf8 (unsafeHexString "6d79537472696e67\00") `shouldEqual` "myString"
        toUtf8 (unsafeHexString "65787065637465642076616c7565\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
          `shouldEqual` "expected value"

      it "can convert strings to hex" do
        fromUtf8 "myString" `shouldEqual` unsafeHexString "6d79537472696e67"
        fromUtf8 "myString\00" `shouldEqual` unsafeHexString "6d79537472696e67"
        fromUtf8 "expected value\00\00\00" `shouldEqual` unsafeHexString "65787065637465642076616c7565"

    describe "ascii tests" do

      it "can convert hex strings to ascii" do

        toAscii (unsafeHexString "6d79537472696e67") `shouldEqual` "myString"
        toAscii (unsafeHexString "6d79537472696e6700") `shouldEqual` "myString\0000"
      ...
      it "can convert asci to hex" do
        fromAscii "myString" `shouldEqual` unsafeHexString "6d79537472696e67"
        fromAscii "myString\00" `shouldEqual` unsafeHexString "6d79537472696e6700"
