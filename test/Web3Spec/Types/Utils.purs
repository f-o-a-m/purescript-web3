...
utilsSpec = describe "utils-spec" do
    ...
    describe "utf tests" do
      ...
      it "can convert hex strings to utf8" do
        toUtf8 (unsafePartial unsafeHexString "6d79537472696e67") `shouldEqual` "myString"
        toUtf8 (unsafePartial unsafeHexString "6d79537472696e67\00") `shouldEqual` "myString"
        toUtf8 (unsafePartial unsafeHexString "65787065637465642076616c7565\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
          `shouldEqual` "expected value"

      it "can convert strings to hex" do
        fromUtf8 "myString" `shouldEqual` unsafePartial unsafeHexString "6d79537472696e67"
        fromUtf8 "myString\00" `shouldEqual` unsafePartial unsafeHexString "6d79537472696e67"
        fromUtf8 "expected value\00\00\00" `shouldEqual` unsafePartial unsafeHexString "65787065637465642076616c7565"

    describe "ascii tests" do

      it "can convert hex strings to ascii" do

        toAscii (unsafePartial unsafeHexString "6d79537472696e67") `shouldEqual` "myString"
        toAscii (unsafePartial unsafeHexString "6d79537472696e6700") `shouldEqual` "myString\0000"
      --  toAscii (unsafeHexString "0300000035e8c6d54c5d127c9dcebe9e1a37ab9b05321128d097590a3c100000000000006521df642ff1f5ec0c3a7aa6cea6b1e7b7f7cda2cbdf07362a85088e97f19ef94331c955c0e9321ad386428c")
      ...
      it "can convert asci to hex" do
        fromAscii "myString" `shouldEqual` unsafePartial unsafeHexString "6d79537472696e67"
        fromAscii "myString\00" `shouldEqual` unsafePartial unsafeHexString "6d79537472696e6700"
