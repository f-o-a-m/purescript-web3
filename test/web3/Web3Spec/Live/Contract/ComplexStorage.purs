...
type BoolVectorValFn
  = Tagged (SProxy "boolVectorVal(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))
...
--------------------------------------------------------------------------------
type Bytes16ValFn
  = Tagged (SProxy "bytes16Val()") (Tuple0)
...
type Bytes2VectorListValFn
  = Tagged (SProxy "bytes2VectorListVal(uint256,uint256)") (Tuple2 (UIntN (D2 :& D5 :& DOne D6)) (UIntN (D2 :& D5 :& DOne D6)))
...
--------------------------------------------------------------------------------
type Int224ValFn
  = Tagged (SProxy "int224Val()") (Tuple0)
...
--------------------------------------------------------------------------------
type IntListValFn
  = Tagged (SProxy "intListVal(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))
...
--------------------------------------------------------------------------------
type StringValFn
  = Tagged (SProxy "stringVal()") (Tuple0)
