...
type BoolVectorValFn = Tagged (Proxy "boolVectorVal(uint256)") (Tuple1 (UIntN (D2 :& D5 :& DOne D6)))
...
type Bytes2VectorListValFn = Tagged (Proxy "bytes2VectorListVal(uint256,uint256)") (Tuple2 (UIntN (D2 :& D5 :& DOne D6)) (UIntN (D2 :& D5 :& DOne D6)))
