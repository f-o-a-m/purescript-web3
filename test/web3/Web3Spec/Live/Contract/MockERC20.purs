...
newtype Transfer = Transfer {to :: Address,from :: Address,amount :: (UIntN (D2 :& D5 :& DOne D6))}
...
type TransferFn = Tagged (SProxy "transfer(address,uint256)") (Tuple2 (Tagged (SProxy "to") Address) (Tagged (SProxy "amount") (UIntN (D2 :& D5 :& DOne D6))))
