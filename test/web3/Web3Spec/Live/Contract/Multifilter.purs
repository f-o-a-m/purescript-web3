...
type FireE1Fn = Tagged (SProxy "fireE1(uint256)") (Tuple1 (Tagged (SProxy "_value") (UIntN (D2 :& D5 :& DOne D6))))
...
type FireE2Fn = Tagged (SProxy "fireE2(uint256)") (Tuple1 (Tagged (SProxy "_value") (UIntN (D2 :& D5 :& DOne D6))))
