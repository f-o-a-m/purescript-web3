...
instance indexedEventE1 :: IndexedEvent (Tuple0 ) (Tuple1 (Tagged (Proxy "value1") (UIntN (D2 :& D5 :& DOne D6)))) E1 where
  isAnonymous _ = false
...
instance indexedEventE2 :: IndexedEvent (Tuple0 ) (Tuple1 (Tagged (Proxy "value2") (UIntN (D2 :& D5 :& DOne D6)))) E2 where
  isAnonymous _ = false
...
type FireE1Fn = Tagged (Proxy "fireE1(uint256)") (Tuple1 (Tagged (Proxy "_value") (UIntN (D2 :& D5 :& DOne D6))))

fireE1 :: TransactionOptions NoPay -> { _value :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 HexString
fireE1 x0 r = uncurryFields  r $ fireE1' x0
   where
    fireE1' :: TransactionOptions NoPay -> (Tagged (Proxy "_value") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
...
type FireE2Fn = Tagged (Proxy "fireE2(uint256)") (Tuple1 (Tagged (Proxy "_value") (UIntN (D2 :& D5 :& DOne D6))))

fireE2 :: TransactionOptions NoPay -> { _value :: (UIntN (D2 :& D5 :& DOne D6)) } -> Web3 HexString
fireE2 x0 r = uncurryFields  r $ fireE2' x0
   where
    fireE2' :: TransactionOptions NoPay -> (Tagged (Proxy "_value") (UIntN (D2 :& D5 :& DOne D6))) -> Web3 HexString
