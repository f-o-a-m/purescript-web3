...
import Network.Ethereum.Web3.Solidity (Tuple0, Tuple1(..), UIntN, class IndexedEvent)
...
instance indexedEventE1 :: IndexedEvent (Tuple0) (Tuple1 (Tagged (Proxy "value1") (UIntN 256))) E1 where
  isAnonymous _ = false
...
instance indexedEventE2 :: IndexedEvent (Tuple0) (Tuple1 (Tagged (Proxy "value2") (UIntN 256))) E2 where
  isAnonymous _ = false
...
--------------------------------------------------------------------------------
type FireE1Fn
  = Tagged (Proxy "fireE1(uint256)") (Tuple1 (Tagged (Proxy "_value") (UIntN 256)))

fireE1 :: TransactionOptions NoPay -> { _value :: (UIntN 256) } -> Web3 HexString
fireE1 x0 r = uncurryFields r $ fireE1' x0
  where
  fireE1' :: TransactionOptions NoPay -> (Tagged (Proxy "_value") (UIntN 256)) -> Web3 HexString
...
--------------------------------------------------------------------------------
type FireE2Fn
  = Tagged (Proxy "fireE2(uint256)") (Tuple1 (Tagged (Proxy "_value") (UIntN 256)))

fireE2 :: TransactionOptions NoPay -> { _value :: (UIntN 256) } -> Web3 HexString
fireE2 x0 r = uncurryFields r $ fireE2' x0
  where
  fireE2' :: TransactionOptions NoPay -> (Tagged (Proxy "_value") (UIntN 256)) -> Web3 HexString
