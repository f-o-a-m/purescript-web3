module Network.Ethereum.Web3.Types.TokenUnit
  ( class TokenUnit, fromMinorUnit, toMinorUnit
...
newtype Value (a :: TokenUnit) = Value BigNumber

data ProxyTU (a :: TokenUnit) = ProxyTU
...
instance unitSpecNoPay :: TokenUnitSpec (NoPay t) where divider = const zero

foreign import data MinorUnit :: Token -> TokenUnit
instance unitSpecMinorUnit :: TokenUnitSpec (MinorUnit t) where divider = createDivider 0

foreign import data MinorUnitE3 :: Token -> TokenUnit
instance unitSpecMinorUnitE3 :: TokenUnitSpec (MinorUnitE3 t) where divider = createDivider 3

foreign import data MinorUnitE6 :: Token -> TokenUnit
instance unitSpecMinorUnitE6 :: TokenUnitSpec (MinorUnitE6 t) where divider = createDivider 6

foreign import data MinorUnitE9 :: Token -> TokenUnit
instance unitSpecMinorUnitE9 :: TokenUnitSpec (MinorUnitE9 t) where divider = createDivider 9

foreign import data MinorUnitE12 :: Token -> TokenUnit
instance unitSpecMinorUnitE12 :: TokenUnitSpec (MinorUnitE12 t) where divider = createDivider 12

foreign import data MinorUnitE15 :: Token -> TokenUnit
instance unitSpecMinorUnitE15 :: TokenUnitSpec (MinorUnitE15 t) where divider = createDivider 15

foreign import data MinorUnitE18 :: Token -> TokenUnit
instance unitSpecMinorUnitE18 :: TokenUnitSpec (MinorUnitE18 t) where divider = createDivider 18

foreign import data MinorUnitE21 :: Token -> TokenUnit
instance unitSpecMinorUnitE21 :: TokenUnitSpec (MinorUnitE21 t) where divider = createDivider 21
