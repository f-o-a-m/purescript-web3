...
import Network.Ethereum.Web3.Types (Web3, Address, BigNumber, Block, BlockNumber, BlockMode, HexString, Transaction, TransactionOptions, TransactionReceipt, Change, FilterId, Filter, SyncStatus)
...
eth_getBalance :: forall p e . IsAsyncProvider p => Address -> BlockMode -> Web3 p e BigNumber
eth_getBalance addr cm = unsafeCoerceWeb3 $ remote "eth_getBalance" addr cm :: Web3 p () BigNumber

-- | Returns the value from a storage position at a given address
eth_getStorageAt :: forall p e. IsAsyncProvider p => Address -> BigNumber -> BlockMode -> Web3 p e HexString
...
eth_getTransactionCount :: forall p e. IsAsyncProvider p => Address -> BlockMode -> Web3 p e BigNumber
...
eth_getBlockTransactionCountByNumber :: forall p e. IsAsyncProvider p => BlockMode -> Web3 p e BigNumber
...
eth_getUncleCountByBlockNumber :: forall p e. IsAsyncProvider p => BlockMode -> Web3 p e BigNumber
eth_getUncleCountByBlockNumber cm = unsafeCoerceWeb3 $ remote "eth_getUncleCountByBlockNumber" cm :: Web3 p () BigNumber

-- | Returns code at a given address
eth_getCode :: forall p e. IsAsyncProvider p => Address -> BlockMode -> Web3 p e HexString
...
eth_estimateGas :: forall p e. IsAsyncProvider p => TransactionOptions -> BlockMode -> Web3 p e BigNumber
...
eth_getTransactionByBlockNumberAndIndex :: forall p e. IsAsyncProvider p => BlockMode -> BigNumber -> Web3 p e Transaction
...
eth_getUncleByBlockNumberAndIndex :: forall p e. IsAsyncProvider p => BlockMode -> BigNumber -> Web3 p e Block
...
eth_getBlockByNumber :: forall p e . IsAsyncProvider p => BlockMode -> Web3 p e Block
...
eth_call :: forall p e . IsAsyncProvider p => TransactionOptions -> BlockMode -> Web3 p e HexString
