...
import Network.Ethereum.Web3.Types.Types (Address, Block(..), BlockMode(..), BlockNumber, Change(..), ETH, FalseOrObject(..), Filter(..), FilterId(..), HexString, Sign(..), Signed(..), SyncStatus(..), Transaction(..), TransactionOptions(..), TransactionReceipt(..), Web3(..), _address, _data, _from, _fromBlock, _gas, _gasPrice, _nonce, _to, _toBlock, _topics, _value, asSigned, defaultFilter, defaultTransactionOptions, hexLength, mkAddress, mkHexString, unAddress, unHex)
